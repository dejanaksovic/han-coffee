...
const googleAuthhander = async(req, res) => {
    ...
    //set coockies
    res.cookie("accessToken", accessToken, {encode: String, maxAge: 1000*6*10, httpOnly: false, sameSite: 'lax', domain: 'netlify.app'})
    ...
    res.cookie("role", user.role, {encode: String, maxAge: 1000*6*10, httpOnly: false, sameSite: 'none'})
